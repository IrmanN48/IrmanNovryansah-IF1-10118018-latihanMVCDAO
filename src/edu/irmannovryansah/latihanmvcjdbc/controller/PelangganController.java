 ...
 */
package edu.irmannovryansah.latihanmvcjdbc.controller;

import edu.irmannovryansah.latihanmvcjdbc.model.PelangganModel;
import edu.irmannovryansah.latihanmvcjdbc.view.PelangganView;
...
public class PelangganController {
    ...
    public void resetPelanggan(PelangganView view){
     ...
     public void updatePelanggan(PelangganView view){
         if (view.getTablePelanggan().getSelectedRow() == 0) {
             
             JOptionPane.showMessageDialog(view, "Silakan  selesi baris  data  yang  akan diubah");
             return;
     ...
     public void deletePelanggan(PelangganView view){
          if (view.getTablePelanggan().getSelectedRow( )==  0) {
             ...
             JOptionPane.showMessageDialog(view, "Silakan  selesi baris  data  yang  akan dihapus");
             return;
          }
